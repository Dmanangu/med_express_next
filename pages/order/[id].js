						...
						<List>
							...
							<ListItem>
								<Grid container>
									...
									<Grid item xs={6}>
										<Typography align="right">₱{orderItem[0].itemsPrice}</Typography>
									</Grid>
								</Grid>
							</ListItem>
							<ListItem>
								<Grid container>
									...
									<Grid item xs={6}>
										<Typography align="right">₱{orderItem[0].taxPrice}</Typography>
									</Grid>
								</Grid>
							</ListItem>
							<ListItem>
								<Grid container>
									...
									<Grid item xs={6}>
										<Typography align="right">₱{orderItem[0].shippingPrice}</Typography>
									</Grid>
								</Grid>
							</ListItem>
							<ListItem>
